    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm(
            ...
            .then((result) => {
                setLoading(false);
                setResult(true);
                setFormData({}); // Clearing form data after successful submission
                form.current.reset();
            }, (error) => {
                setLoading(false);
            });
                    ...
                    <div className="form-group">
                        <div className="entry-box">
                            ...
                            <input id="form_number" type="number" name="number"
                                ...
                                onChange={handleChange}
                                placeholder="Type your Number" required="required"
                    ...
                    <div className="text-right">
                        ...
                        {result &&
                            <p className="success-message mt-20">Your Message has been successfully sent. I will contact you
                                soon. <br /> Name: {formData.name}, Email: {formData.email}</p>}
                    </div>
                </div>
            </form>
        </div>
