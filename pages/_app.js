...
function MyApp({Component, pageProps}) {
    ...
    return (<>
        <Head>
            <title>BZ Technologies</title>
            <meta name="description" content="Elevate your digital footprint with our expert web and mobile app development services for all business sizes. Hire top-tier talent for your mobile and web development needs today."/>
